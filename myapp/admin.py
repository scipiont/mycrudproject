...
from django.contrib import admin
from .models import Client, Product, Order
from .admin_mixins import ExportCsvMixin, ExportPdfMixin

class ClientAdmin(admin.ModelAdmin, ExportCsvMixin, ExportPdfMixin):
    actions = ["export_as_csv", "export_as_pdf"]

class ProductAdmin(admin.ModelAdmin, ExportCsvMixin, ExportPdfMixin):
    actions = ["export_as_csv", "export_as_pdf"]

class OrderAdmin(admin.ModelAdmin, ExportCsvMixin, ExportPdfMixin):
    actions = ["export_as_csv", "export_as_pdf"]
